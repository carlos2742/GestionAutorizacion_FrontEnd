...
/* @ngInject */
/**
 * Esta clase representa un controlador de Angular correspondiente a la vista de detalles de un gasto.
 */
export default class ModalAprobarGastoController {
    constructor($uibModalInstance, $q, toastr, entidad, paginaActual, PeticionesService) {
        this.$uibModalInstance = $uibModalInstance;
        this.$q = $q;
        this.toastr = toastr;

        this.titulo = 'Solicitud de Gasto';
